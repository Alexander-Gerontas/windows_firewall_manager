...
namespace fireWall
{
    class MainWindowsClass1
    {
        // Διαχειριστης κανονων του firewall
...
//
//        private TrayWindow form2 = new TrayWindow();
//
//        private string mode;
//
//        
...
//                    {
//                        rule.Description = (rule.Action == NET_FW_ACTION_.NET_FW_ACTION_ALLOW) ? "Allow outgoing UDP and TCP traffic" : "Always block all traffic";
//
...
//            if (windonsUpdateCheckBox.Checked) SvchostRules.setRule("windowsUpdate", "allow");
//            else SvchostRules.setRule("windowsUpdate", "block");
//
//            if (windowsDhcpClientCheckBox.Checked) SvchostRules.setRule("windowsDHCP", "allow");
//            else SvchostRules.setRule("windowsDHCP", "block");
//
//            if (windowsDnsClientCheckBox.Checked) SvchostRules.setRule("windowsDNS", "allow");
//            else SvchostRules.setRule("windowsDNS", "block");
//        }
       ...
       /* private void close_Click(object sender, EventArgs e)
        ...
        /*private void exceptionGrid_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (blackGrid.SelectedRows.Count == 1)
            {
